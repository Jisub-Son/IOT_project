...
const char *ssid = "U+Net9700";  //ENTER YOUR WIFI SETTINGS
const char *password = "HB797@0FE6";
...
void loop() {
  ...
  //GET Data
  Link = "/lol/summoner/v4/summoners/by-name/54720857del?api_key=RGAPI-2b6e0c3f-3416-4563-af8d-7934e9acb8f3";
